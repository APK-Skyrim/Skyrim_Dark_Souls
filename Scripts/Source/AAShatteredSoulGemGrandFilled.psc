ScriptName AAShatteredSoulGemGrandFilled extends ObjectReference 
...
MiscObject Property AASoulGemGrandShatteredFilled auto
Event OnEquipped(Actor akActor)
    If (akActor == Game.GetPlayer())
		...
		Game.GetPlayer().RemoveItem(AASoulGemGrandShatteredFilled, 1)
