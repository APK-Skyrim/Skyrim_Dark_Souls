ScriptName AAShatteredSoulGemCommon extends ObjectReference 
...
MiscObject Property AASoulGemCommonShattered auto
Event OnEquipped(Actor akActor)
    If (akActor == Game.GetPlayer())
		...
		Game.GetPlayer().RemoveItem(AASoulGemCommonShattered, 1)
